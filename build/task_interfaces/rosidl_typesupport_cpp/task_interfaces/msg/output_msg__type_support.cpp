...
static const _OutputMsg_type_support_symbol_names_t _OutputMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_interfaces, msg, OutputMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, task_interfaces, msg, OutputMsg)),
  }
};
...
{
  return &::task_interfaces::msg::rosidl_typesupport_cpp::OutputMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, task_interfaces, msg, OutputMsg)() {
  return get_message_type_support_handle<task_interfaces::msg::OutputMsg>();
}
